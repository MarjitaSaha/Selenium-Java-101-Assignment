...
public class Testng1 {
  ...
  public void thirdScenario() throws InterruptedException
  {
	  driver.manage().window().maximize();
		...
		//filling out data
		driver.findElement(By.name("name")).sendKeys("kashish");
		driver.findElement(By.name("email")).sendKeys("pirt3K2hi2h@gmail.com");
		driver.findElement(By.name("password")).sendKeys("Pi5t0l0wn3r");
		driver.findElement(By.name("company")).sendKeys("World Turnover Pvt. Ltd");
		driver.findElement(By.name("website")).sendKeys("www.worldturnover.org");
		
		driver.findElement(By.name("city")).sendKeys("koshishganj");
		driver.findElement(By.name("address_line1")).sendKeys("12s, gangadhar road");
		driver.findElement(By.name("address_line2")).sendKeys("kasishganj,Buxar");
		driver.findElement(By.id("inputState")).sendKeys("Uttar pradesh");
